<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="wasuchem.Home" %>
...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>Educrown HTML5 Education Template</title>
                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><h2>LOGO NEEDED</h2></div></a>
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog-item sm-mb30 xs-mb30 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-thumb">
                            <a href="blog.html"><img src="assest/img/blog/blog-1.jpg" alt=""></a>
                        </div>
                        <div class="blog-details padding30">
                            <h3 class="blog-title font20 mb30"><a href="blog.html"> Mr Musonza</a></h3>
                            <p class="blog-meta font14 mt20"><a href="#">physics teacher</a> email <a href="#">wasuatwasu</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                        <div class="single-footer footer-list white xs-center xs-mb50">
                            <ul>
                                ...
                                <li><a href="login.aspx">Management</a></li>
